...
When reviewing code, I start by tracking the variables from beginning to end to
see how they are modified, renamed, and ultimately shaped into a useful result.
I appreciate intuitive/simple variable names so the reviewer isn't forced
to put together a puzzle based on nothing but tracing logic. Comments, docstrings,
and pseudocode are also very helpful in code review. When receiving a code review,
I appreciate detailed comments, questions, and honest feedback. For example
if something was confusing or incomplete.
...
Containers can help us keep our projects in sync with the various project dependencies,
languages, versions etc. Containers help us maintain project specific 
environments for the sake of seamless integration of all the parts as a whole.
They are a helpful management tool providing organizational value as well
as practical operational value.
